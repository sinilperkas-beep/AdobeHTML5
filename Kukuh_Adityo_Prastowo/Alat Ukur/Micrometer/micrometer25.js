...
lib.ssMetadata = [
		{name:"micrometer25_atlas_1", frames: [[530,323,863,124],[0,0,1220,287],[0,289,528,230],[1222,0,438,321],[1662,0,335,73]]}
];
...
(lib.CachedBmp_5 = function() {
	this.initialize(ss["micrometer25_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-315,-107.4,0.5,0.5);
	...
	this.statusHasil.setTransform(1254,-402.15,1.409,1.409);

	this.hasilBtn = new lib.kalibrasiBtn();
	this.hasilBtn.name = "hasilBtn";
	this.hasilBtn.setTransform(1254.3,-386.45,1.8646,1.409,0,0,0,0.2,-0.1);
	...
	this.statusBelajar.setTransform(924.25,-402.15,1.409,1.409);

	this.belajarBtn = new lib.kalibrasiBtn();
	this.belajarBtn.name = "belajarBtn";
	this.belajarBtn.setTransform(924.45,-386.45,1.8646,1.409,0,0,0,0.1,-0.1);
	...
	this.instance_3.setTransform(-952,-136.7,0.5,0.5);
...
// stage content:
(lib.micrometer25 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(55.75,654.7,0.7813,0.7813);

	this.instance_2 = new lib.BitmapGrTeknik();
	this.instance_2.setTransform(844.45,654.7,0.7813,0.7813);

	this.instance_3 = new lib.BitmapGrTeknik();
	this.instance_3.setTransform(578.75,654.7,0.7813,0.7813);

	this.instance_4 = new lib.BitmapGrTeknik();
	this.instance_4.setTransform(321.5,654.7,0.7813,0.7813);

	this.instance_5 = new lib.BitmapGrTeknik();
	this.instance_5.setTransform(967.85,593.95,0.7813,0.7813);

	this.instance_6 = new lib.BitmapGrTeknik();
	this.instance_6.setTransform(702.05,593.95,0.7813,0.7813);

	this.instance_7 = new lib.BitmapGrTeknik();
	this.instance_7.setTransform(436.35,593.95,0.7813,0.7813);

	this.instance_8 = new lib.BitmapGrTeknik();
	this.instance_8.setTransform(179.1,593.95,0.7813,0.7813);

	this.instance_9 = new lib.BitmapGrTeknik();
	this.instance_9.setTransform(55.75,523.8,0.7813,0.7813);

	this.instance_10 = new lib.BitmapGrTeknik();
	this.instance_10.setTransform(844.45,523.8,0.7813,0.7813);

	this.instance_11 = new lib.BitmapGrTeknik();
	this.instance_11.setTransform(578.75,523.8,0.7813,0.7813);

	this.instance_12 = new lib.BitmapGrTeknik();
	this.instance_12.setTransform(321.5,523.8,0.7813,0.7813);

	this.instance_13 = new lib.BitmapGrTeknik();
	this.instance_13.setTransform(55.75,398.45,0.7813,0.7813);

	this.instance_14 = new lib.BitmapGrTeknik();
	this.instance_14.setTransform(844.45,398.45,0.7813,0.7813);

	this.instance_15 = new lib.BitmapGrTeknik();
	this.instance_15.setTransform(578.75,398.45,0.7813,0.7813);

	this.instance_16 = new lib.BitmapGrTeknik();
	this.instance_16.setTransform(321.5,398.45,0.7813,0.7813);

	this.instance_17 = new lib.BitmapGrTeknik();
	this.instance_17.setTransform(960.25,333,0.7813,0.7813);

	this.instance_18 = new lib.BitmapGrTeknik();
	this.instance_18.setTransform(695.45,333,0.7813,0.7813);

	this.instance_19 = new lib.BitmapGrTeknik();
	this.instance_19.setTransform(429.7,333,0.7813,0.7813);

	this.instance_20 = new lib.BitmapGrTeknik();
	this.instance_20.setTransform(172.5,333,0.7813,0.7813);

	this.instance_21 = new lib.BitmapGrTeknik();
	this.instance_21.setTransform(57.6,264.7,0.7813,0.7813);

	this.instance_22 = new lib.BitmapGrTeknik();
	this.instance_22.setTransform(845.4,264.7,0.7813,0.7813);

	this.instance_23 = new lib.BitmapGrTeknik();
	this.instance_23.setTransform(579.65,264.7,0.7813,0.7813);

	this.instance_24 = new lib.BitmapGrTeknik();
	this.instance_24.setTransform(323.4,264.7,0.7813,0.7813);

	this.instance_25 = new lib.BitmapGrTeknik();
	this.instance_25.setTransform(967.85,201.05,0.7813,0.7813);

	this.instance_26 = new lib.BitmapGrTeknik();
	this.instance_26.setTransform(702.05,201.05,0.7813,0.7813);

	this.instance_27 = new lib.BitmapGrTeknik();
	this.instance_27.setTransform(436.35,201.05,0.7813,0.7813);

	this.instance_28 = new lib.BitmapGrTeknik();
	this.instance_28.setTransform(179.1,201.05,0.7813,0.7813);

	this.instance_29 = new lib.BitmapGrTeknik();
	this.instance_29.setTransform(55.75,140.3,0.7813,0.7813);

	this.instance_30 = new lib.BitmapGrTeknik();
	this.instance_30.setTransform(844.45,140.3,0.7813,0.7813);

	this.instance_31 = new lib.BitmapGrTeknik();
	this.instance_31.setTransform(578.75,140.3,0.7813,0.7813);

	this.instance_32 = new lib.BitmapGrTeknik();
	this.instance_32.setTransform(321.5,140.3,0.7813,0.7813);

	this.instance_33 = new lib.BitmapGrTeknik();
	this.instance_33.setTransform(960.25,73.85,0.7813,0.7813);

	this.instance_34 = new lib.BitmapGrTeknik();
	this.instance_34.setTransform(695.45,73.85,0.7813,0.7813);

	this.instance_35 = new lib.BitmapGrTeknik();
	this.instance_35.setTransform(429.7,73.85,0.7813,0.7813);

	this.instance_36 = new lib.BitmapGrTeknik();
	this.instance_36.setTransform(172.5,73.85,0.7813,0.7813);

	this.instance_37 = new lib.BitmapGrTeknik();
	this.instance_37.setTransform(57.6,4.65,0.7813,0.7813);

	this.instance_38 = new lib.BitmapGrTeknik();
	this.instance_38.setTransform(845.4,4.65,0.7813,0.7813);

	this.instance_39 = new lib.BitmapGrTeknik();
	this.instance_39.setTransform(579.65,4.65,0.7813,0.7813);

	this.instance_40 = new lib.BitmapGrTeknik();
	this.instance_40.setTransform(323.4,4.65,0.7813,0.7813);

	this.instance_41 = new lib.BitmapGrTeknik();
	this.instance_41.setTransform(967.85,454.45,0.7813,0.7813);

	this.instance_42 = new lib.BitmapGrTeknik();
	this.instance_42.setTransform(702.05,454.45,0.7813,0.7813);

	this.instance_43 = new lib.BitmapGrTeknik();
	this.instance_43.setTransform(436.35,454.45,0.7813,0.7813);

	this.instance_44 = new lib.BitmapGrTeknik();
	this.instance_44.setTransform(179.1,454.45,0.7813,0.7813);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_6.png?1788248692736", id:"CachedBmp_6"},
		{src:"images/CachedBmp_2.png?1788248692736", id:"CachedBmp_2"},
		{src:"images/CachedBmp_1.png?1788248692737", id:"CachedBmp_1"},
		{src:"images/micrometer25_atlas_1.png?1788248692676", id:"micrometer25_atlas_1"}
	],
	preloads: []
};
