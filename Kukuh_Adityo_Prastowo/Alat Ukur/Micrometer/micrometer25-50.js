...
lib.ssMetadata = [
		{name:"micrometer25_50_atlas_1", frames: [[0,0,557,293],[337,295,16,32],[337,329,19,16],[0,295,335,73]]}
];
...
(lib.CachedBmp_16 = function() {
	this.initialize(ss["micrometer25_50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.mulai = 25; // Inisialisasi batas awal (0, 25, 50, 75, dll)
...
// stage content:
(lib.micrometer2550 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_25.png?1788251398799", id:"CachedBmp_25"},
		{src:"images/CachedBmp_13.png?1788251398799", id:"CachedBmp_13"},
		{src:"images/CachedBmp_12.png?1788251398799", id:"CachedBmp_12"},
		{src:"images/micrometer25_50_atlas_1.png?1788251398763", id:"micrometer25_50_atlas_1"}
	],
	preloads: []
};
