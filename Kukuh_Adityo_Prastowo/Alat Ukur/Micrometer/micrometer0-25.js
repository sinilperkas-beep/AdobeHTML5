...
lib.ssMetadata = [
		{name:"micrometer0_25_atlas_1", frames: [[0,295,863,124],[0,0,557,293],[559,75,16,32],[577,75,19,16],[559,0,335,73]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2702,848);
...
(lib.CachedBmp_32 = function() {
	this.initialize(ss["micrometer0_25_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1138.5,-87.85,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_29();
	this.instance_1.setTransform(-1298.9,-86.4,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_2
	this.instance_2 = new lib.CachedBmp_31();
	this.instance_2.setTransform(-326.5,-113.45,0.5,0.5);
	...
	this.statusHasil.setTransform(1253.75,-402.15,1.4089,1.4089);

	this.hasilBtn = new lib.kalibrasiBtn();
	this.hasilBtn.name = "hasilBtn";
	this.hasilBtn.setTransform(1254.3,-386.45,1.8646,1.4089,0,0,0,0.3,-0.1);
	...
	this.statusBelajar.setTransform(924,-402.15,1.4089,1.4089);

	this.belajarBtn = new lib.kalibrasiBtn();
	this.belajarBtn.name = "belajarBtn";
	this.belajarBtn.setTransform(924.3,-386.45,1.8646,1.4089,0,0,0,0.2,-0.1);
	...
	this.instance_3.setTransform(-50.3,-120.85,0.5,0.5);
	...
	this.instance_4.setTransform(-931.4,190.25,0.5,0.5);

	this.spindel = new lib.spindel();
	this.spindel.name = "spindel";
	this.spindel.setTransform(-608.2,-43.25,1.2557,1.0375,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.spindel},{t:this.instance_4},{t:this.nama},{t:this.instance_3},{t:this.skalaSpindel},{t:this.hasil_1},{t:this.belajarBtn},{t:this.statusBelajar},{t:this.hasilBtn},{t:this.statusHasil}]}).wait(1));

	// Layer_4
	this.instance_5 = new lib.CachedBmp_34();
	this.instance_5.setTransform(-1394.8,-117.3,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Micrometer, new cjs.Rectangle(-1394.8,-418.1,3006.6,724.8), null);


// stage content:
(lib.micrometer025 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(55.65,654.5,0.7813,0.7813);

	this.instance_2 = new lib.BitmapGrTeknik();
	this.instance_2.setTransform(844.35,654.5,0.7813,0.7813);

	this.instance_3 = new lib.BitmapGrTeknik();
	this.instance_3.setTransform(578.6,654.5,0.7813,0.7813);

	this.instance_4 = new lib.BitmapGrTeknik();
	this.instance_4.setTransform(321.35,654.5,0.7813,0.7813);

	this.instance_5 = new lib.BitmapGrTeknik();
	this.instance_5.setTransform(967.75,593.75,0.7813,0.7813);

	this.instance_6 = new lib.BitmapGrTeknik();
	this.instance_6.setTransform(701.95,593.75,0.7813,0.7813);

	this.instance_7 = new lib.BitmapGrTeknik();
	this.instance_7.setTransform(436.25,593.75,0.7813,0.7813);

	this.instance_8 = new lib.BitmapGrTeknik();
	this.instance_8.setTransform(179,593.75,0.7813,0.7813);

	this.instance_9 = new lib.BitmapGrTeknik();
	this.instance_9.setTransform(55.65,523.65,0.7813,0.7813);

	this.instance_10 = new lib.BitmapGrTeknik();
	this.instance_10.setTransform(844.35,523.65,0.7813,0.7813);

	this.instance_11 = new lib.BitmapGrTeknik();
	this.instance_11.setTransform(578.6,523.65,0.7813,0.7813);

	this.instance_12 = new lib.BitmapGrTeknik();
	this.instance_12.setTransform(321.35,523.65,0.7813,0.7813);

	this.instance_13 = new lib.BitmapGrTeknik();
	this.instance_13.setTransform(55.65,398.25,0.7813,0.7813);

	this.instance_14 = new lib.BitmapGrTeknik();
	this.instance_14.setTransform(844.35,398.25,0.7813,0.7813);

	this.instance_15 = new lib.BitmapGrTeknik();
	this.instance_15.setTransform(578.6,398.25,0.7813,0.7813);

	this.instance_16 = new lib.BitmapGrTeknik();
	this.instance_16.setTransform(321.35,398.25,0.7813,0.7813);

	this.instance_17 = new lib.BitmapGrTeknik();
	this.instance_17.setTransform(960.15,332.8,0.7813,0.7813);

	this.instance_18 = new lib.BitmapGrTeknik();
	this.instance_18.setTransform(695.35,332.8,0.7813,0.7813);

	this.instance_19 = new lib.BitmapGrTeknik();
	this.instance_19.setTransform(429.6,332.8,0.7813,0.7813);

	this.instance_20 = new lib.BitmapGrTeknik();
	this.instance_20.setTransform(172.4,332.8,0.7813,0.7813);

	this.instance_21 = new lib.BitmapGrTeknik();
	this.instance_21.setTransform(57.5,264.55,0.7813,0.7813);

	this.instance_22 = new lib.BitmapGrTeknik();
	this.instance_22.setTransform(845.3,264.55,0.7813,0.7813);

	this.instance_23 = new lib.BitmapGrTeknik();
	this.instance_23.setTransform(579.5,264.55,0.7813,0.7813);

	this.instance_24 = new lib.BitmapGrTeknik();
	this.instance_24.setTransform(323.25,264.55,0.7813,0.7813);

	this.instance_25 = new lib.BitmapGrTeknik();
	this.instance_25.setTransform(967.75,200.85,0.7813,0.7813);

	this.instance_26 = new lib.BitmapGrTeknik();
	this.instance_26.setTransform(701.95,200.85,0.7813,0.7813);

	this.instance_27 = new lib.BitmapGrTeknik();
	this.instance_27.setTransform(436.25,200.85,0.7813,0.7813);

	this.instance_28 = new lib.BitmapGrTeknik();
	this.instance_28.setTransform(179,200.85,0.7813,0.7813);

	this.instance_29 = new lib.BitmapGrTeknik();
	this.instance_29.setTransform(55.65,140.1,0.7813,0.7813);

	this.instance_30 = new lib.BitmapGrTeknik();
	this.instance_30.setTransform(844.35,140.1,0.7813,0.7813);

	this.instance_31 = new lib.BitmapGrTeknik();
	this.instance_31.setTransform(578.6,140.1,0.7813,0.7813);

	this.instance_32 = new lib.BitmapGrTeknik();
	this.instance_32.setTransform(321.35,140.1,0.7813,0.7813);

	this.instance_33 = new lib.BitmapGrTeknik();
	this.instance_33.setTransform(960.15,73.65,0.7813,0.7813);

	this.instance_34 = new lib.BitmapGrTeknik();
	this.instance_34.setTransform(695.35,73.65,0.7813,0.7813);

	this.instance_35 = new lib.BitmapGrTeknik();
	this.instance_35.setTransform(429.6,73.65,0.7813,0.7813);

	this.instance_36 = new lib.BitmapGrTeknik();
	this.instance_36.setTransform(172.4,73.65,0.7813,0.7813);

	this.instance_37 = new lib.BitmapGrTeknik();
	this.instance_37.setTransform(57.5,4.45,0.7813,0.7813);

	this.instance_38 = new lib.BitmapGrTeknik();
	this.instance_38.setTransform(845.3,4.45,0.7813,0.7813);

	this.instance_39 = new lib.BitmapGrTeknik();
	this.instance_39.setTransform(579.5,4.45,0.7813,0.7813);

	this.instance_40 = new lib.BitmapGrTeknik();
	this.instance_40.setTransform(323.25,4.45,0.7813,0.7813);

	this.instance_41 = new lib.BitmapGrTeknik();
	this.instance_41.setTransform(967.75,454.25,0.7813,0.7813);

	this.instance_42 = new lib.BitmapGrTeknik();
	this.instance_42.setTransform(701.95,454.25,0.7813,0.7813);

	this.instance_43 = new lib.BitmapGrTeknik();
	this.instance_43.setTransform(436.25,454.25,0.7813,0.7813);

	this.instance_44 = new lib.BitmapGrTeknik();
	this.instance_44.setTransform(179,454.25,0.7813,0.7813);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_34.png?1788251554341", id:"CachedBmp_34"},
		{src:"images/CachedBmp_33.png?1788251554341", id:"CachedBmp_33"},
		{src:"images/CachedBmp_28.png?1788251554341", id:"CachedBmp_28"},
		{src:"images/CachedBmp_27.png?1788251554341", id:"CachedBmp_27"},
		{src:"images/micrometer0_25_atlas_1.png?1788251554287", id:"micrometer0_25_atlas_1"}
	],
	preloads: []
};
