...
lib.ssMetadata = [
		{name:"micrometer50_75_atlas_1", frames: [[0,0,557,293],[337,295,16,32],[337,329,19,16],[0,295,335,73]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,3786,1062);


(lib.CachedBmp_16 = function() {
	this.initialize(ss["micrometer50_75_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.spindel2 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("ASpiXIAAEmQAAAMh5AAMghgAAAQh4AAAAgMIAAkmQAAgDAeAAMAkVAAAQAeAAAAADg");
	this.shape.setTransform(-12.125,0.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","#FFFFFF","#343434","#828282","#494949","#FFFFFF"],[0,0.243,0.282,0.553,0.682,1],0,-15.4,0,15.5).s().p("AwwCbQh4AAAAgMIAAkmQAAgDAeAAMAkVAAAQAeAAAAADIAAEmQAAAMh5AAg");
	this.shape_1.setTransform(-12.125,0.075);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("EgzOgJjMBjbAAAQECAAAAA+IAARLQAAA+kCAAMhjbAAAQhAAAAAgPIAAypQAAgPBAAAg");
	this.shape_2.setTransform(44.0929,0.0047,0.0697,1.4284,90);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#000000","#FFFFFF","#343434","#828282","#494949","#FFFFFF"],[0,0.243,0.282,0.553,0.682,1],-334.3,0,334.3,0).s().p("EgzOAJkQhAAAAAgPIAAypQAAgPBAAAMBjbAAAQECAAAAA+IAARLQAAA+kCAAg");
	this.shape_3.setTransform(44.0929,0.0047,0.0697,1.4284,90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.spindel2, new cjs.Rectangle(-132.4,-24.3,264.9,48.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","#FFFFFF","#343434","#828282","#494949","#FFFFFF"],[0,0.243,0.282,0.553,0.682,1],0.1,-28.4,0.1,28.5).s().p("EAh/AEcIhQABMhBcAAAIhQgBIyYABQl6AAAAgWIAAodQAAgGBfAAMBcQAAAIAaABIU3gBQBfAAAAAGIAAIdQAAAWl6AAg");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("TEKNIK", "36px 'Arial Rounded MT Bold'", "#00CCFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 44;
	this.text.lineWidth = 139;
	this.text.parent = this;
	this.text.setTransform(341.35,-17.65,2.3415,1);

	this.text_1 = new cjs.Text("Gr ", "36px 'Arial Rounded MT Bold'", "#FFFF00");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 44;
	this.text_1.lineWidth = 57;
	this.text_1.parent = this;
	this.text_1.setTransform(109.7,-19.35,2.3415,1);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EgrwgKKQAEAAAFAAEgswAAFIACkYIgClqQAAgKAwgCQAGAAAGgBEAsxABFIgBEKIABEJQAAAahMAMQgYAEgfADEAoPAKLMhQdAAA");
	this.shape.setTransform(286.625,8.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","#FFFFFF","#343434","#828282","#494949","#FFFFFF"],[0,0.243,0.282,0.553,0.682,1],0.6,-65,-0.9,65.1).s().p("EAoiAKKIgUAAMhQdAAAIgHAAIg8gBQjmgEABgtIAGpTIACkYIAGlqQAAgJAogDIANAAIADAAIAJAAMBXXAAAQBJAAAAAMIgHKiIgBAhIgBEJIgFEJQAAAZhGANQgYAEgfADIgiACIgmACIg8ABg");
	this.shape_1.setTransform(286.7248,8.15);

	this.spindel2 = new lib.spindel2();
	this.spindel2.name = "spindel2";
	this.spindel2.setTransform(656.6,4.55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Egp3AJmQhBAAAAgPIAAytQAAgPBBAAMBQuAAAQECgBAAA/IAARPQAAA+kCAAg");
	this.shape_2.setTransform(893.9357,8.5,1.2242,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.spindel2},{t:this.shape_1},{t:this.shape},{t:this.text_1},{t:this.text}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.rachet, new cjs.Rectangle(-0.9,-57.9,1230.9,132.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.mulai = 50; // Inisialisasi batas awal (0, 25, 50, 75, dll)
	...
	this.instance.setTransform(-1693.5,-87.85,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_14();
	this.instance_1.setTransform(-1853.9,-86.4,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_2
	this.instance_2 = new lib.CachedBmp_16();
	this.instance_2.setTransform(-326.5,-113.5,0.5,0.5);
	...
	this.hasil.setTransform(-1099.05,-152.85);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.skalaPutar},{t:this.rachet},{t:this.hasil},{t:this.instance_2}]}).wait(1));
	...
	this.statusHasil.setTransform(1094.85,-402.15,1.4089,1.4089);

	this.hasilBtn = new lib.kalibrasiBtn();
	this.hasilBtn.name = "hasilBtn";
	this.hasilBtn.setTransform(1095.2,-386.45,1.8646,1.4089,0,0,0,0.2,-0.1);
	...
	this.statusBelajar.setTransform(765.15,-402.15,1.4089,1.4089);

	this.belajarBtn = new lib.kalibrasiBtn();
	this.belajarBtn.name = "belajarBtn";
	this.belajarBtn.setTransform(765.45,-386.45,1.8646,1.4089,0,0,0,0.2,-0.1);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(5,1,1).p("Eh+ngLeMD9PAAAIAAW9Mj9PAAAg");
	this.shape.setTransform(762.6,-44.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CCCCCC").s().p("Eh+nALfIAA29MD9PAAAIAAW9g");
	this.shape_1.setTransform(762.6,-44.825);

	this.spindel = new lib.spindel();
	this.spindel.name = "spindel";
	this.spindel.setTransform(-608.2,-43.25,1.2557,1.0375,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.spindel},{t:this.shape_1},{t:this.shape},{t:this.skalaSpindel},{t:this.hasil_1},{t:this.belajarBtn},{t:this.statusBelajar},{t:this.hasilBtn},{t:this.statusHasil}]}).wait(1));
	...
	this.nama.setTransform(-1000.25,297.6);

	this.instance_3 = new lib.CachedBmp_25();
	this.instance_3.setTransform(-1936.65,-117.3,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.nama}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Micrometer, new cjs.Rectangle(-1936.6,-418.1,3548.3999999999996,831.8), null);


// stage content:
(lib.micrometer5075 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.micrometer.setTransform(749.35,358.2,0.3822,0.7813,0,0,0,0.4,0.4);
	...
	this.instance_1.setTransform(55.7,654.6,0.7813,0.7813);

	this.instance_2 = new lib.BitmapGrTeknik();
	this.instance_2.setTransform(844.4,654.6,0.7813,0.7813);

	this.instance_3 = new lib.BitmapGrTeknik();
	this.instance_3.setTransform(578.65,654.6,0.7813,0.7813);

	this.instance_4 = new lib.BitmapGrTeknik();
	this.instance_4.setTransform(321.4,654.6,0.7813,0.7813);

	this.instance_5 = new lib.BitmapGrTeknik();
	this.instance_5.setTransform(967.8,593.85,0.7813,0.7813);

	this.instance_6 = new lib.BitmapGrTeknik();
	this.instance_6.setTransform(702,593.85,0.7813,0.7813);

	this.instance_7 = new lib.BitmapGrTeknik();
	this.instance_7.setTransform(436.3,593.85,0.7813,0.7813);

	this.instance_8 = new lib.BitmapGrTeknik();
	this.instance_8.setTransform(179.05,593.85,0.7813,0.7813);

	this.instance_9 = new lib.BitmapGrTeknik();
	this.instance_9.setTransform(55.7,523.75,0.7813,0.7813);

	this.instance_10 = new lib.BitmapGrTeknik();
	this.instance_10.setTransform(844.4,523.75,0.7813,0.7813);

	this.instance_11 = new lib.BitmapGrTeknik();
	this.instance_11.setTransform(578.65,523.75,0.7813,0.7813);

	this.instance_12 = new lib.BitmapGrTeknik();
	this.instance_12.setTransform(321.4,523.75,0.7813,0.7813);

	this.instance_13 = new lib.BitmapGrTeknik();
	this.instance_13.setTransform(55.7,398.35,0.7813,0.7813);

	this.instance_14 = new lib.BitmapGrTeknik();
	this.instance_14.setTransform(844.4,398.35,0.7813,0.7813);

	this.instance_15 = new lib.BitmapGrTeknik();
	this.instance_15.setTransform(578.65,398.35,0.7813,0.7813);

	this.instance_16 = new lib.BitmapGrTeknik();
	this.instance_16.setTransform(321.4,398.35,0.7813,0.7813);

	this.instance_17 = new lib.BitmapGrTeknik();
	this.instance_17.setTransform(960.2,332.9,0.7813,0.7813);

	this.instance_18 = new lib.BitmapGrTeknik();
	this.instance_18.setTransform(695.4,332.9,0.7813,0.7813);

	this.instance_19 = new lib.BitmapGrTeknik();
	this.instance_19.setTransform(429.65,332.9,0.7813,0.7813);

	this.instance_20 = new lib.BitmapGrTeknik();
	this.instance_20.setTransform(172.45,332.9,0.7813,0.7813);

	this.instance_21 = new lib.BitmapGrTeknik();
	this.instance_21.setTransform(57.55,264.65,0.7813,0.7813);

	this.instance_22 = new lib.BitmapGrTeknik();
	this.instance_22.setTransform(845.35,264.65,0.7813,0.7813);

	this.instance_23 = new lib.BitmapGrTeknik();
	this.instance_23.setTransform(579.55,264.65,0.7813,0.7813);

	this.instance_24 = new lib.BitmapGrTeknik();
	this.instance_24.setTransform(323.35,264.65,0.7813,0.7813);

	this.instance_25 = new lib.BitmapGrTeknik();
	this.instance_25.setTransform(967.8,200.95,0.7813,0.7813);

	this.instance_26 = new lib.BitmapGrTeknik();
	this.instance_26.setTransform(702,200.95,0.7813,0.7813);

	this.instance_27 = new lib.BitmapGrTeknik();
	this.instance_27.setTransform(436.3,200.95,0.7813,0.7813);

	this.instance_28 = new lib.BitmapGrTeknik();
	this.instance_28.setTransform(179.05,200.95,0.7813,0.7813);

	this.instance_29 = new lib.BitmapGrTeknik();
	this.instance_29.setTransform(55.7,140.2,0.7813,0.7813);

	this.instance_30 = new lib.BitmapGrTeknik();
	this.instance_30.setTransform(844.4,140.2,0.7813,0.7813);

	this.instance_31 = new lib.BitmapGrTeknik();
	this.instance_31.setTransform(578.65,140.2,0.7813,0.7813);

	this.instance_32 = new lib.BitmapGrTeknik();
	this.instance_32.setTransform(321.4,140.2,0.7813,0.7813);

	this.instance_33 = new lib.BitmapGrTeknik();
	this.instance_33.setTransform(960.2,73.75,0.7813,0.7813);

	this.instance_34 = new lib.BitmapGrTeknik();
	this.instance_34.setTransform(695.4,73.75,0.7813,0.7813);

	this.instance_35 = new lib.BitmapGrTeknik();
	this.instance_35.setTransform(429.65,73.75,0.7813,0.7813);

	this.instance_36 = new lib.BitmapGrTeknik();
	this.instance_36.setTransform(172.45,73.75,0.7813,0.7813);

	this.instance_37 = new lib.BitmapGrTeknik();
	this.instance_37.setTransform(57.55,4.55,0.7813,0.7813);

	this.instance_38 = new lib.BitmapGrTeknik();
	this.instance_38.setTransform(845.35,4.55,0.7813,0.7813);

	this.instance_39 = new lib.BitmapGrTeknik();
	this.instance_39.setTransform(579.55,4.55,0.7813,0.7813);

	this.instance_40 = new lib.BitmapGrTeknik();
	this.instance_40.setTransform(323.35,4.55,0.7813,0.7813);

	this.instance_41 = new lib.BitmapGrTeknik();
	this.instance_41.setTransform(967.8,454.35,0.7813,0.7813);

	this.instance_42 = new lib.BitmapGrTeknik();
	this.instance_42.setTransform(702,454.35,0.7813,0.7813);

	this.instance_43 = new lib.BitmapGrTeknik();
	this.instance_43.setTransform(436.3,454.35,0.7813,0.7813);

	this.instance_44 = new lib.BitmapGrTeknik();
	this.instance_44.setTransform(179.05,454.35,0.7813,0.7813);
...
p.nominalBounds = new cjs.Rectangle(633.4,354.9,731.9,366.30000000000007);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_25.png?1788251482160", id:"CachedBmp_25"},
		{src:"images/CachedBmp_13.png?1788251482160", id:"CachedBmp_13"},
		{src:"images/CachedBmp_12.png?1788251482160", id:"CachedBmp_12"},
		{src:"images/micrometer50_75_atlas_1.png?1788251482089", id:"micrometer50_75_atlas_1"}
	],
	preloads: []
};
