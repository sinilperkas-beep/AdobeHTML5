...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(292.55,-68.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E6E6E6").s().p("EgtrAB/IAAj9MBbXAAAIAAD9g");
	this.shape_1.setTransform(292.55,-68.825);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#CCCCCC").ss(1,1,1).p("AK3hUQAAABgBABQgeBAioAuQjOA5kiAAQkgAAjPg5Qiogvgeg/QgBgBAAgB");
	this.shape_2.setTransform(491.975,48.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_3.setTransform(251.0554,92.17);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.dasar},{t:this.shape_1},{t:this.shape}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BitmapGrTeknik.png?1788505188158", id:"BitmapGrTeknik"}
	],
	preloads: []
};
